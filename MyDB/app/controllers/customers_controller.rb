class CustomersController < ApplicationController
  ...
  def index
    # @list_of_customer =[1,2,3]
    # @customers = Customer.blacklisted_customers(@list_of_customer)
  ...
  def create
    ...
    respond_to do |format|
      if @customer.save
        CustomerMailer.with(customer:@customer).welcome_mailer.deliver
  ...
  private
    ...
    def customer_params
      params.expect(customer: [ :name, :email ,:about_me,:profile_photo,:phone_number,:date_of_birth])
    end
